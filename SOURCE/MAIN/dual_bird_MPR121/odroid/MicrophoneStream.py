...
class MicrophoneStream(object):
    ...
    def generator(self, audio_init_time, audio_length = 0):
        ...
        while not self.closed:
            ...
            ## Since the maximum streaming audio is 60 seconds, I will make the google speech recognition system return empyy and wich code I will make it start again every 45 seconds.
            if (((time.time() - audio_init_t) >= 40)):
                return
